...
public class RichbetRepository : IRichbetRepository
{
    ...
    {
        var user = new RichbetUser {AppUserId = identityUserId, Multiplier = 1.0f, Points = 0, DailyRedeemed = false};
    ...
    {
        _context.RichbetUsers.Remove(new RichbetUser {AppUserId = identityUserId});
