function Snack(givenOptions) {
  ...
  function _createSnack() {
    ...
    document
      .getElementsByClassName("snack-container")[0]
      .appendChild(snackBody);
    ...
    let timer = setInterval(() => {
      ...
      if (leftTime == 0) {
        ...
        if (_ifContainerNotActive()) {
          // if there is no more snack in the container - remove the container
  ...
  function _createTimerBar() {
    ...
    switch (_Options.type) {
      ...
      case "error":
        ...
        break;
      default:
        timerBar.style.backgroundColor = "#EE5353";
        break;
    }
    return timerBar;
  }
  ...
  function _ifContainerNotActive() {
    ...
    if (typeof element != "undefined" && element != null) {
      // double check of existence to prevent bugs from user interaction
      if (
        !document.getElementsByClassName("snack-container")[0].childElementCount
      ) {
        return true;
      }
    } else {
