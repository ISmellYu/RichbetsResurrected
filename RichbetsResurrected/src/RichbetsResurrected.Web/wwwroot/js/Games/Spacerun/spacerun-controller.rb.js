    ...
    function renderPlayersList(data) {
        ...
        data.forEach((element) => {
            ...
            if (playersStyling.has(element.discordUserId)) {
                tr.innerHTML = `<td style="background-image: url(${element.avatarUrl});"><p class="${playersStyling.get(
                    element.discordUserId
                )}">${element.userName}</p></td>${cashout}${cashoutAmount}`;
            } else {
