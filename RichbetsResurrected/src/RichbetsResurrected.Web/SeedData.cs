...
public static class SeedData
{
    public static void Initialize(IServiceProvider serviceProvider)
    {
        using (var dbContext = serviceProvider.GetRequiredService<AppDbContext>())
        {
            ...
            {
                Name = "Pink Leopard", Description = "pink_leopard", Price = 5000, SubCategoryId = patternSubCategory.Id, AvailableQuantity = -1, 
                IsAvailable = true, ImageUrl = "https://i.pinimg.com/736x/b4/ab/5d/b4ab5dec71a33a5e81198915dd517718.jpg"
            };
            
            var tiger = new Item
            {
                Name = "Tiger", Description = "tiger", Price = 5000, SubCategoryId = patternSubCategory.Id, AvailableQuantity = -1, 
                IsAvailable = true, ImageUrl = "https://i.postimg.cc/Bvw94dgD/tiger.jpg"
            };
            
            var giraffe = new Item
            {
                Name = "Giraffe", Description = "giraffe", Price = 5000, SubCategoryId = patternSubCategory.Id, AvailableQuantity = -1, 
            ...
            var poland = new Item
            {
                Name = "Poland", Description = "poland2", Price = 5000, SubCategoryId = patternSubCategory.Id, AvailableQuantity = -1, 
            ...
            var fade = new Item
            {
                Name = "Fade", Description = "fade", Price = 5000, SubCategoryId = patternSubCategory.Id, AvailableQuantity = -1, 
                IsAvailable = true, ImageUrl = "https://ih1.redbubble.net/image.213300789.4460/flat,750x1000,075,f.u2.jpg"
            };
            
            var marbleFade = new Item
            {
                Name = "Marble Fade", Description = "marble-fade", Price = 5000, SubCategoryId = patternSubCategory.Id, AvailableQuantity = -1, 
            ...
            {
                Name = "Strawberries", Description = "strawberries", Price = 15000, SubCategoryId = bannerSubCategory.Id, AvailableQuantity = -1, 
            ...
            var cash = new Item
            {
                Name = "Cash", Description = "cash", Price = 15000, SubCategoryId = bannerSubCategory.Id, AvailableQuantity = -1, 
                IsAvailable = true, ImageUrl = "https://thumbs.dreamstime.com/b/money-cash-pattern-28000619.jpg"
            };
            
            var polishFlag = new Item
            {
                Name = "Polish Flag", Description = "poland", Price = 15000, SubCategoryId = bannerSubCategory.Id, AvailableQuantity = -1, 
                IsAvailable = true, ImageUrl = "https://upload.wikimedia.org/wikipedia/en/thumb/1/12/Flag_of_Poland.svg/1200px-Flag_of_Poland.svg.png"
            };
            
            var fastfood = new Item
            {
                Name = "Fastfood", Description = "fastfood", Price = 15000, SubCategoryId = bannerSubCategory.Id, AvailableQuantity = -1, 
            ...
            {
                Name = "Redline", Description = "redline", Price = 15000, SubCategoryId = bannerSubCategory.Id, AvailableQuantity = -1, 
            ...
            var fire = new Item
            {
                Name = "Fire", Description = "anim-fire", Price = 250000, SubCategoryId = animatedSubCategory.Id, AvailableQuantity = -1, 
            ...
            {
                Name = "Epilepsy", Description = "anim-epilepsy", Price = 250000, SubCategoryId = animatedSubCategory.Id, AvailableQuantity = -1, 
            ...
            {
                Name = "Color Wave", Description = "anim-color-wave", Price = 250000, SubCategoryId = animatedSubCategory.Id, AvailableQuantity = -1, 
