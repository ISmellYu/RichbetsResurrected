...
public static class SeedData
{
    public static void Initialize(IServiceProvider serviceProvider)
    {
        using (var dbContext = serviceProvider.GetRequiredService<AppDbContext>())
        {
            ...
            dbContext.SubCategories.AddRange(effectSubCategory, patternSubCategory, bannerSubCategory,
                animatedSubCategory);
            dbContext.SaveChanges();
            ...
            {
                Name = "Pink Leopard",
                Description = "pink_leopard",
                Price = 5000,
                SubCategoryId = patternSubCategory.Id,
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://i.pinimg.com/736x/b4/ab/5d/b4ab5dec71a33a5e81198915dd517718.jpg"
            };
            ...
            var tiger = new Item
            {
                ...
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://i.postimg.cc/Bvw94dgD/tiger.jpg"
            };
            ...
            var giraffe = new Item
            {
                ...
                IsAvailable = true,
                ImageUrl =
                    "https://murals-weblinc.netdna-ssl.com/product_images/giraffe-print-10263661/5ec82fa4bd89dd0018f779d1/product_large_image.jpg?c=1590177700"
            };
            ...
            var fade = new Item
            {
                ...
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://ih1.redbubble.net/image.213300789.4460/flat,750x1000,075,f.u2.jpg"
            };
            ...
            var marbleFade = new Item
            {
                ...
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://i.imgur.com/Dik8l2g.png"
            };
            ...
            var strawberries = new Item
            {
                ...
                Price = 15000,
                SubCategoryId = bannerSubCategory.Id,
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl =
                    "https://static.vecteezy.com/system/resources/previews/002/859/881/large_2x/a-pattern-background-with-small-and-cute-strawberries-and-flowers-and-leaves-arranged-randomly-simple-pattern-design-template-free-vector.jpg"
            };
            ...
            var cash = new Item
            {
                ...
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://thumbs.dreamstime.com/b/money-cash-pattern-28000619.jpg"
            };
            ...
            var fastfood = new Item
            {
                ...
                IsAvailable = true,
                ImageUrl =
                    "https://www.creativefabrica.com/wp-content/uploads/2020/11/01/Fast-Food-Seamless-Pattern-1-Graphics-6399037-1.jpg"
            };
            ...
            var redline = new Item
            {
                ...
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://i.postimg.cc/90MQb6TD/redline.jpg"
            };
            ...
            {
                Name = "Fire",
                Description = "anim-fire",
                Price = 250000,
                SubCategoryId = animatedSubCategory.Id,
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/2/22/Animated_fire_by_nevit.gif"
            };

            var epilepsy = new Item
            {
                Name = "Epilepsy",
                Description = "anim-epilepsy",
                Price = 250000,
                SubCategoryId = animatedSubCategory.Id,
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://i.pinimg.com/originals/92/b8/19/92b819465492e2f9f1a385cf7916d3a0.gif"
            };

            var colorWave = new Item
            {
                Name = "Color Wave",
                Description = "anim-color-wave",
                Price = 250000,
                SubCategoryId = animatedSubCategory.Id,
                AvailableQuantity = -1,
                IsAvailable = true,
                ImageUrl = "https://i.pinimg.com/originals/84/d8/7e/84d87eb7e536135161c55887d878d44b.gif"
            };


            // Seed items
            dbContext.Items.AddRange(pinkLeopard, tiger, giraffe, poland, fade, marbleFade, strawberries, cash,
                polishFlag, fastfood, redline,
